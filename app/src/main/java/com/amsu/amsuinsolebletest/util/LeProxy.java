...
public class LeProxy {
    ...
    private int mDeviceTypeInsole = 1;
    private int mDeviceTypeNewCloth = 2;
    private int mDeviceType = mDeviceTypeNewCloth;
    ...
    private final BleCallBack mBleCallBack = new BleCallBack() {
        ...
        public void onServicesDiscovered(String address) {
            ...
            if (address.startsWith("AMSU_P")){//鞋垫
                mDeviceType = mDeviceTypeInsole;
            }
            else if (address.startsWith("AMSU_E")){//新版衣服
                mDeviceType = mDeviceTypeNewCloth;
            }
    ...
    private class ServicesDiscoveredTask extends TimerTask {
        ...
        public void run() {
            switch (i) {
                case 0:
                    if (mDeviceType==mDeviceTypeInsole){
                        ...
                        UUID serUuid = UUID.fromString("6e400001-b5a3-f393-e0a9-e50e24dcca9e");
                        UUID charUuid = UUID.fromString("6e400003-b5a3-f393-e0a9-e50e24dcca9e");
                        UUID charUuid_1 = UUID.fromString("6e400004-b5a3-f393-e0a9-e50e24dcca9e");
                        boolean success = enableNotification(address, serUuid, charUuid);

                        Log.i(TAG, "Enable 0x1002 notification success: " + success);

                        try {
                            Thread.sleep(1000);
                            boolean success1 = enableNotification(address, serUuid, charUuid_1);
                            Log.i(TAG, "Enable 0x1002 notification success1: " + success1);

                        } catch (InterruptedException e) {
                            e.printStackTrace();
                        }
                    }
                    else if (mDeviceType==mDeviceTypeNewCloth){
                        //打开模组默认的数据接收通道【0x1002】，这一步成功才能保证APP收到数据
                        //boolean success = enableNotification(address, BleUUIDS.PRIMARY_SERVICE, BleUUIDS.CHARACTERS[1]);
                        UUID serUuid = UUID.fromString("6e400001-b5a3-f393-e0a9-e50e24dcca9e");
                        ...
                        UUID charUuid_3 = UUID.fromString("00000002-0000-1000-8000-00805f9b34fb");
                        UUID charUuid_4 = UUID.fromString("00000003-0000-1000-8000-00805f9b34fb");
                        UUID charUuid_5 = UUID.fromString("00000004-0000-1000-8000-00805f9b34fb");
                        UUID charUuid_6 = UUID.fromString("00000005-0000-1000-8000-00805f9b34fb");
                        UUID charUuid_7 = UUID.fromString("00000006-0000-1000-8000-00805f9b34fb");
*/
                        ...
                        try {
                            ...
                            /*Thread.sleep(1000);
                            boolean success_7 = enableNotification(address, serUuid, charUuid_7);
                            Log.i(TAG, "success_7: " + success_7);*/
