...
public class HexKeyboardUtil {
    ...
    public HexKeyboardUtil(EditText edit, int maxLength, Activity activity) {
        this.inputEditText = edit;
        this.maxLength = maxLength;

        //Activity act = (Activity) inputEditText.getContext();
    ...
    // 隐藏系统的输入键盘
    public void hideSoftKeyboard(Activity ctx, EditText edit) {
